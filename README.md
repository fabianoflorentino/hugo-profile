...
- Minimalist Design
- SEO Friendly
- **Multilingual/i18n Support** - Available in English, Spanish, French, German, Portuguese, and easily extensible
...
The theme supports internationalization (i18n) out of the box. You can create a multilingual website with different language versions.
...
1. See the [I18N.md](I18N.md) file for detailed documentation
2. Check the `exampleSite/hugo-multilingual.yaml` for a complete multilingual configuration example
3. Translation files are located in the `i18n/` directory
...
For more details, see the [complete i18n documentation](I18N.md).
